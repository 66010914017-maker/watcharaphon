...
<body>
    ...
    <button type="button" class="btn-yes" onclick="changeImage('images/1.jpg')">YES (รูปที่ 1)</button>
    <button type="button" class="btn-no" onclick="changeImage('images/2.jpg')">NO (รูปที่ 2)</button>
